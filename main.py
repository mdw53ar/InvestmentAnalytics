...
stock2 = Stock("AAPL", "Apple", 1000, "2017-02-27", "2023-03-28")
stock3 = Stock("BA", "Boeing", 1000, "2017-02-27", "2023-02-24")
stock4 = Stock("COST", "Costco", 1000, "2017-02-27", "2023-02-24")
stock5 = Stock("CS", "Credit Suisse", 1000, "2017-02-27", "2023-02-24")
